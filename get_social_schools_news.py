...
DIGEST_PROMPT_TEMPLATE = (
    ...
    "- Do not create a separate action or note line for every small fact that shares the same "
    "date and event. Combine closely related facts about one date into ONE entry instead of "
    "several near-identical lines (e.g. merge 'departs at 08:30' and 'returns around 14:30' into "
    "a single trip entry), and never state the same fact once as an action and again as a note.\n"
