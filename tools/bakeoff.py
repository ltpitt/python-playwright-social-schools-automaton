...
from tools.evaluate_digests import build_summary, evaluate_product_case, load_expectations
from tools.run_digest import DEFAULT_CORPUS, apply_llm_overrides, run_corpus
from socialschools.paths import BAKEOFF_FILE, EVAL_DIR, EXPECTATIONS_FILE

DEFAULT_OUTPUT_DIR = EVAL_DIR
DEFAULT_REPORT = BAKEOFF_FILE
...
def main():
    ...
    parser.add_argument("--expectations", default=EXPECTATIONS_FILE)
