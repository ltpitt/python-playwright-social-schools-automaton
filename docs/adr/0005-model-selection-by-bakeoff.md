...
- The corpus is small (tens of posts), so the holdout is a handful of cases. It catches gross overfitting, not subtle differences. Treat a one-case gap as noise.
